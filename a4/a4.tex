...
\begin{enumerate}
	...
	\item %Q6 Frank
        ...
        cheapest path between the two nodes. It's worth noting by the definition of a path(no repeating nodes), 
        the length is bounded by the number of nodes in G, and if G is a linked list, this is simply the number of
        verticies in G.
